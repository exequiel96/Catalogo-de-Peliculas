...
public class AccesoDatosImpl implements IAccesoDatos {
    ...
    public List<Pelicula> listar(String nombreArchivo) throws LecturaDatosEx {
        ...
        try {
            ...
            ex.printStackTrace();
            throw new LecturaDatosEx("Excepcion al lsta peliculas" + ex.getMessage());
        ...
        try {
            ...
            while (linea!= null){
                if(buscar!= null && buscar.equalsIgnoreCase(linea)){
                    resultado= "Pelicula "+ linea+ "encontrada en e indice"+ indice;
                    break;
                }
                linea= entrada.readLine();
                indice++;
    ...
    public void crear(String nombreArchivo) throws AccesoDatosExcepciones {
        ...
        try {
            ...
            ex.printStackTrace();
            throw new AccesoDatosExcepciones("Excepcion al crear el archivo"+ex.getMessage());
